...
export default function ChangeManagementPage({ lang }: ChangeManagementPageProps) {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <ServiceVideoBackground videos={["https://res.cloudinary.com/dbrisux8i/video/upload/v1762015286/openart-video_b6992003_1761933215657_wgjmwh.mp4"]} />

      {/* Content */}
      <div className="relative z-10">
      {/* Hero Section */}
      <section className="relative overflow-hidden border-b border-white/10 bg-gradient-to-br from-orange-900/40 via-black/60 to-black/60 py-32">
      ...
      {/* Benefits Section */}
      <section className="py-20 bg-gradient-to-b from-black/60 to-orange-950/20">
        <div className="mx-auto max-w-6xl px-6">
