...
export default function ERPCRMPage({ lang }: ERPCRMPageProps) {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <ServiceVideoBackground videos={["https://res.cloudinary.com/dbrisux8i/video/upload/v1760435634/kling_20251014_Text_to_Video_Title__The_4174_2_llyqsp.mp4"]} />

      {/* Content */}
      <div className="relative z-10">
      {/* Hero Section */}
      <section className="relative overflow-hidden border-b border-white/10 bg-gradient-to-br from-purple-900/40 via-black/60 to-black/60 py-32">
      ...
      {/* Benefits Section */}
      <section className="py-20 bg-gradient-to-b from-black/60 to-purple-950/20">
        <div className="mx-auto max-w-6xl px-6">
